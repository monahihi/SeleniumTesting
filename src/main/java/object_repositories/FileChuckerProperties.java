...
public class FileChuckerProperties {
	public static By fileChucker_btnChooseFile = By.xpath("//*[contains(@id,'uploadname1')]");
	public static By fileChucker_SelectOption_UploadTo = By.xpath("//*[contains(@id,'firstfile')]/..//*[@value='/' and . = '/uploaddemo/files/']");
	public static By fileChucker_txtNewSubFolder = By.xpath("//*[contains(@id,'newsubdir1')]");
	public static By fileChucker_txtEmailAddress = By.xpath("//*[contains(@id,'formfield-email_address')]");
	public static By fileChucker_txtFirstName = By.xpath("//*[contains(@id,'formfield-first_name')]");
	public static By fileChucker_btnUpload = By.xpath("//*[contains(@id,'uploadbutton') and contains(@value,'Begin Upload')]");
	
	public static By fileChuckerCompleted_txtEmailAddress = By.xpath("//*[@id='fcuploadsummary']/dd[4]");
	public static By fileChuckerCompleted_txtFirstName = By.xpath("//*[@id='fcuploadsummary']/dd[5]");
	public static By fileChuckerCompleted_txtFileName = By.xpath("//*[@id='fcuploadsummary']/..//a[contains(@href,'&file=')]");
	...
	public static void setFileChucker_txtNewSubFolder(By fileChucker_txtNewSubFolder) {
	...
	public static void setFileChucker_txtEmailAddress(By fileChucker_txtEmailAddress) {
